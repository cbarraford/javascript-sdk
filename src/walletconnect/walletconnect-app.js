...
/**
 * WalletConnect app interface.
 * @static
 */
class WalletConnectApp {
  /**
   * Constructs a new WalletConnectApp.
   * @param {String} bridgeServer WalletConnect Bridge server address. Default "https://wallet-bridge.binance.org"
   */
  constructor(bridgeServer = "https://wallet-bridge.binance.org") {
    // Create a walletConnector
    const walletConnector = new WalletConnect({
      bridge: bridgeServer // Required
    });
